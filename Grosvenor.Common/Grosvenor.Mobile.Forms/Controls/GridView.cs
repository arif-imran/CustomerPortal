// // --------------------------------------------------------------------------------------------------------------------
// // <copyright file="GridView.cs" company="Grosvenor">
// //   
// // </copyright>
// // <summary>
// //   GridView
...
namespace Grosvenor.Mobile.Forms.Controls
{
    ...
    public class GridView : Layout<View>
    {
        ...
        public static readonly BindableProperty OrientationProperty =
            BindableProperty.Create<GridView, StackOrientation>(w => w.Orientation, StackOrientation.Vertical,
        ...
        public static readonly BindableProperty SpacingProperty =
            BindableProperty.Create<GridView, double>(w => w.Spacing, 6,
                propertyChanged: (bindable, oldvalue, newvalue) => ((GridView)bindable).OnSizeChanged());
        ...
        public static readonly BindableProperty ItemTemplateProperty =
            BindableProperty.Create<GridView, DataTemplate>(w => w.ItemTemplate, null,
                propertyChanged: (bindable, oldvalue, newvalue) => ((GridView)bindable).OnSizeChanged());
        ...
        public static readonly BindableProperty ItemsSourceProperty =
            BindableProperty.Create<GridView, IEnumerable>(w => w.ItemsSource, null,
